...
cmp $3, %rax
jle extra1 /**** jump to the extra section if number of bytes is at most 45 *****/ 
...
/*nrBRW Computation for messsages at least 60 bytes long*/
...
start:          movq 64(%rsp), %rdx
   ...
   extra1:     cmp $1, %rax
    ...
    three:      movq 64(%rsp), %rdx
		 ...
		 /*prepare_and_add_store 0(%rsi), 8(%rsi), 0(%rdx), 8(%rdx), %r14, %r15*/
		 prepare_and_add 0(%rsi), 8(%rsi), 0(%rdx), 8(%rdx), %r14, %r15
		 addq $15, %rsi     
		       
                /*prepare_and_add_store 0(%rsi), 8(%rsi),16(%rdx), 24(%rdx),%rax, %rbx*/
                prepare_and_add 0(%rsi), 8(%rsi),16(%rdx), 24(%rdx),%rax, %rbx
                addq $15, %rsi
